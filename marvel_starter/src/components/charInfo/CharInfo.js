    ...
    return (
        <>
            <div className="char__basics">
                <img src={thumbnail} alt={name} className={clazzContain}/>
                <div>
                    ...
                    <div className="char__btns">
                        ...
                        <a href={wiki} className="button button__secondary" rel="noopener noreferrer">
            ...
            <ul className="char__comics-list">
                {comics.length > 0 ? null : 'No comics found at the moment'}
                {
                    comics.map((item, i) => {
